              ...
              <Table>
                ...
                <Table.Body>
                  <Table.Row>
                    ...
                    <Table.Cell>
                      {`${new Date("2023-11-12").toLocaleDateString("nl-NL")} ${new Date(
                        "2023-11-12T11:42"
                  ...
                  <Table.Row>
                    ...
                    <Table.Cell>
                      {`${new Date("2023-11-01").toLocaleDateString("nl-NL")} ${new Date(
                        "2023-11-01T15:40"
                      ).toLocaleTimeString("nl-NL", { hour: "2-digit", minute: "2-digit" })}`}
                    </Table.Cell>
                    <Table.Cell>
                ...
                <Table>
                  ...
                  <Table.Body>
                    <Table.Row>
                      ...
                      <Table.Cell>
                        {`${new Date("2023-10-10").toLocaleDateString("nl-NL")} ${new Date(
                          "2023-10-10T07:49"
                        ).toLocaleTimeString("nl-NL", { hour: "2-digit", minute: "2-digit" })}`}
                      </Table.Cell>
                      <Table.Cell>
                    ...
                    <Table.Row>
                      ...
                      <Table.Cell>Klaas Helmers</Table.Cell>
                      <Table.Cell>
                        {`${new Date("2023-09-18").toLocaleDateString("nl-NL")} ${new Date(
                          "2023-09-18T15:40"
                        ).toLocaleTimeString("nl-NL", { hour: "2-digit", minute: "2-digit" })}`}
                      </Table.Cell>
                      <Table.Cell>
                    ...
                    <Table.Row>
                      ...
                      <Table.Cell>Marjolein Boomer</Table.Cell>
                      <Table.Cell>
                        {`${new Date("2023-09-17").toLocaleDateString("nl-NL")} ${new Date(
                          "2023-09-17T07:49"
                        ).toLocaleTimeString("nl-NL", { hour: "2-digit", minute: "2-digit" })}`}
                      </Table.Cell>
                      <Table.Cell>
                    ...
                    <Table.Row>
                      ...
                      <Table.Cell>Marise Ent</Table.Cell>
                      <Table.Cell>
                        {`${new Date("2023-09-15").toLocaleDateString("nl-NL")} ${new Date(
                          "2023-09-15T15:40"
                        ).toLocaleTimeString("nl-NL", { hour: "2-digit", minute: "2-digit" })}`}
                      </Table.Cell>
                      <Table.Cell>
                    ...
                    <Table.Row>
                      ...
                      <Table.Cell>Klaas Helmers</Table.Cell>
                      <Table.Cell>
                        {`${new Date("2023-09-09").toLocaleDateString("nl-NL")} ${new Date(
                          "2023-09-09T11:42"
                        ).toLocaleTimeString("nl-NL", { hour: "2-digit", minute: "2-digit" })}`}
                      </Table.Cell>
                      <Table.Cell>
