...
function HomePage() {
  ...
  return (
    <>
      ...
      <Overlap>
        <Image alt="" className="ams-image ams-aspect-ratio-16-5" src={vindenImage} />
      ...
      <Grid paddingTop="x-large" paddingBottom="2x-large">
        ...
        <Grid.Cell span={{ narrow: 4, medium: 5, wide: 8 }} start={{ narrow: 1, medium: 4, wide: 5 }}>
          ...
          <Card>
            <Image alt="" className="ams-image ams-card__image" src={stormschadeImage} />
            <Card.HeadingGroup tagline="Nieuws">
              <Card.Heading level={3} size="level-4">
                <Card.Link href="/amsterdam/nieuws">Waar u stormschade kunt melden</Card.Link>
              </Card.Heading>
            </Card.HeadingGroup>
            <Paragraph>
        ...
        {cards.map(({ heading, image }) => (
          <Grid.Cell span={4} key={heading}>
            <Card>
              <Image alt="" className="ams-image ams-card__image" src={image} />
              <Card.HeadingGroup tagline="Nieuws">
                <Card.Heading level={3} size="level-4">
                  <Card.Link href="/amsterdam/nieuws">{heading}</Card.Link>
                </Card.Heading>
              </Card.HeadingGroup>
            </Card>
          </Grid.Cell>
