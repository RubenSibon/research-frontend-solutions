...
import stylesheet from "./amsterdam.css?url";
...
export default function AmsterdamLayout({ children }: { children: ReactNode }) {
  return (
      ...
      <Screen maxWidth="wide">
        <Header
          menuItems={[
            ...
            <Header.MenuLink href="/amsterdam/zoeken" key={3} fixed>
              Zoeken
            </Header.MenuLink>,
          ]}
          ...
          <Grid.Cell span="all">
            <PageMenu>
              {footerLinks.map(({ href, label }) => (
                <PageMenu.Link href={href} key={label}>
                  {label}
                </PageMenu.Link>
              ))}
