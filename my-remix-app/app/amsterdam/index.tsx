...
function HomePage() {
  ...
  return (
    <>
      ...
      <Overlap>
        <Image alt="" className="ams-image ams-aspect-ratio--2x-wide" src={vindenImage} />
      ...
      <Grid paddingVertical="medium">
        ...
        <Grid.Cell span={{ narrow: 4, medium: 5, wide: 8 }} start={{ narrow: 1, medium: 4, wide: 5 }}>
          ...
          <Card>
            <Image alt="" className="ams-image" src={stormschadeImage} />
        ...
        {cards.map(({ heading, image }) => (
          <Grid.Cell span={4} key={heading}>
            <Card>
              <Image alt="" className="ams-image" src={image} />
              <Card.HeadingGroup tagline="Nieuws">
                <Heading level={2} size="level-4">
